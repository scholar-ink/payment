...
func TestZgSharingNotify_Handle(t *testing.T) {

	notify := new(ZgSharingNotify)
	...
	result := notify.Handle(ret, func(merchantNo int32) (md5Key string, err error) {
		return "b2ab57c9cd3d44d19d6514cfb5755a66", nil
	}, func(data *ZgSharingNotifyData) error {
		fmt.Println(data)
		return nil
	})
